...
<%@page import="controller.shopServlet"%>
                        ...
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                            <div class="row">
                                <%
                                    ...
                                    ArrayList<Product> arr = (ArrayList<Product>) request.getAttribute("ls");
                                    int start = 0, end = 4;
                                    if (arr.size() < 4) {
                                        end = arr.size();
                                    }
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                    <div class="single-popular-items mb-50 text-center">
                                        <div class="popular-img">
                                            <img src="images/<%=p.getProduct_images()%>" alt="">
                                            <div class="img-cap">
                                                <form action="cartServlet" method="post" style="font-size: 200%">
                                                    <span><input type="submit" name="addCart" value="<%=p.getProduct_id()%>"/>Add to Cart</span>
                                                </form>
                                            </div>
                                        ...
                                        <div class="popular-caption">
                                            <h3><a href="product_details.html"><%=p.getProduct_name()%></a></h3>
                                ...
                                <ul>
                                    ...
                                    %>
                                    <li class="pagination">
                                        <a href="search.jsp?start=<%=a%>&end=<%=b%>"><%=i%></a>
                                    </li>
                                    <%
                                        }
                                    %>
