...
<html lang="zxx">
    ...
    <body>
        ...
        <main>
            ...
            <!--================Single Product Area =================-->
            <%
                if (request.getAttribute("prDetail") != null) {
                    Product p = (Product) request.getAttribute("prDetail");
            %>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="product_img_slide owl-carousel">
                                <div class="single_product_img">
                                    <img src="images/<%=p.getProduct_images()%>" alt="#" class="img-fluid">
                                </div>
                        ...
                        <div class="col-lg-8">
                            <div class="single_product_text text-center">
                                ...
                                <form action="prDetailServlet" method="get">
                                    <div class="card_area">
                                        <div class="product_count_area">
                                            <p><input value="<%=p.getProduct_id()%>" name="idProduct"/></p>
